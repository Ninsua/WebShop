...
export class CheckOutComponent implements OnInit {
	...
	constructor(private cookie:CookieService, private basket:BasketService, private db: AngularFireDatabase,private location: Location, private router: Router) {
	...
	confirm(){
		...
		if (this.street == null || this.city == null || this.zipCode == null || this.country == null) {
			alert('User must fill shipping address!');
			return;
		}
		else if (this.itemListStr.length == 0){
			alert ('User\'s shopping cart is empty!');
			return;
		}
